          ...
          <div style={{ display: 'flex', gap: '24px', width: '100%', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, minWidth: '300px' }}>
              <div style={{ 
                ...
                <h3 style={{ fontSize: '20px', fontWeight: 700, color: 'var(--color-text-dark)', marginBottom: '24px', marginTop: 0 }}>Total à payer</h3>
                ...
                <div style={{ marginTop: '32px' }}>
                  <button 
                    ...
                    onClick={onNext}
                    style={{ width: '100%', padding: '16px', fontSize: '16px', display: 'flex', justifyContent: 'center', gap: '8px', alignItems: 'center' }}
                  >
                    Confirmer et Payer
                  ...
                  <p style={{ textAlign: 'center', fontSize: '12px', color: 'var(--color-text-light)', marginTop: '12px', marginBottom: 0 }}>
